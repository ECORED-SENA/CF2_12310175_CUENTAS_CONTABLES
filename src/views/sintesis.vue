  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center
      .col-lg-12.mb-5.bgs.p-4.brad
        figure
          img(src="@/assets/curso/sintesis.svg", alt="La imagen presenta un esquema conceptual de cuentas nominales y registros contables, mostrando ingresos, gastos y costos, sus características y movimientos, además de cuentas de orden y registros contables, explicando la estructura básica utilizada para clasificar y registrar operaciones financieras.")
      .col-auto
